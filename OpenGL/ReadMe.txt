...
OpenGLDoc.h, OpenGLDoc.cpp - the document
    ...
    The Document will have the following strings:
        File extension:      off
        File type ID:        OpenGL.Document
        Main frame caption:  OpenGL
        Doc type name:       OpenGL
        Filter name:         OpenGL Files (*.off)
        File new short name: OpenGL
        File type long name: OpenGL.Document
...
res\OpenGLDoc.ico
    ...
    for the COpenGLDoc class.  This icon is included by the main
    resource file OpenGL.rc.
